...
internal typealias FontType = FontConvertible.Font
...
internal enum FontFamily {
  ...
  internal enum Roboto {
    ...
    internal static let medium = FontConvertible(name: "Roboto-Medium", family: "Roboto", path: "roboto.ttf")
    internal static let all: [FontConvertible] = [bold, medium]
  }
  internal static let allCustomFonts: [FontConvertible] = [Poppins.all, Roboto.all].flatMap { $0 }
